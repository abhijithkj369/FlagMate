                        ...
                        <div className="space-y-6">
                            ...
                            >
                                ...
                                <div className="flex items-end gap-2">
                                    <span className="text-4xl font-bold text-rose-red">{healthScore.score}</span>
                                    <span className="text-slate-500 mb-1">/ 10</span>
                                </div>
                                <div className="w-full bg-white/50 rounded-full h-2 mt-2">
                                    <div className="bg-rose-red h-2 rounded-full" style={{ width: `${(healthScore.score / 10) * 100}%` }}></div>
                                </div>
